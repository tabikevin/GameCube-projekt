-- GameCube adatbázis – teljes schema + seed adatok
-- Szerver: MySQL 8.0   |   Karakter: utf8mb4_unicode_ci
-- Legutóbb frissítve: 2026-04-21
-- Megjegyzés: seller_id / seller_price oszlopok és a kapcsolódó eljárások
--             már ebben a fájlban szerepelnek; külön migration script nem szükséges.
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_users_get_all` (
    IN `p_page` INT,
    IN `p_page_size` INT,
    IN `p_role` ENUM('user','seller','admin'),
