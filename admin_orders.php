...
if (!$user || $user["role"] !== "admin") {
    ...
    echo "<p style='color:white;background:#050814;padding:20px;font-family:system-ui'>
            Nincs jogosultságod az admin rendeléskezelő megnyitásához.
          </p>";
    exit;
}

function assignKeysForOrder(mysqli $conn, int $order_id): void
{
    $stmt = $conn->prepare("
...
<header class="gc-header shadow-sm mb-4">
    <nav class="navbar navbar-expand-lg navbar-dark container">
        ...
        <div class="ms-auto d-flex gap-2">
            <a href="admin.php" class="btn btn-sm btn-outline-light gc-btn-ghost">Termékek</a>
...
<main class="container" style="max-width: 1000px;">
    <div class="gc-hero-card p-4 mb-4">
        ...
        <p class="text-light-50 mb-3">
            Itt tudod a banki átutalásos (<code>pending</code>) rendeléseket jóváhagyni.
            Jóváhagyás után a rendszer kiosztja a játék kulcsokat a felhasználónak.
        </p>
